...
<template>
  <main class="py-8">
    <div class="container">
      <h1 class="text-4xl font-bold text-center">Cyber Defenders Challenges</h1>
      ...
      >
        <BaseCard class="text-center" v-for="i in 10" :key="i">
          <template #title> Challenge Title #Num </template>
      ...
      <ThePagination class="mt-8 mx-auto" />
    </div>
  </main>
</template>
